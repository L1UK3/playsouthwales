    ...
    if weekday in [5, 6]: # Saturday or Sunday
        if current_date.day <= 7:
            ...
            if weekday == 5: # Third Saturday
                ...
                if q_month == 0:
                    add_event("League Cup", date_str, "09:30:00", 1, "Swansea Jack", "CUP", "TCG", "Large prize pool league cup", "Exclusive Playmat + CP + Packs", "£20.00")
                elif q_month == 1:
                    ...
                    add_event("League Cup", date_str, "09:30:00", 5, "Badger Badger", "CUP", "TCG", "Large prize pool league cup", "Exclusive Playmat + CP + Packs", "£20.00")
            ...
            if weekday == 5: # Fourth Saturday
                ...
                q_month = (current_date.month - 1) % 3
                if q_month == 0:
                    add_event("League Cup", date_str, "09:30:00", 2, "Common Meeple", "CUP", "TCG", "Large prize pool league cup", "Exclusive Playmat + CP + Packs", "£20.00")
                elif q_month == 1:
                    add_event("League Cup", date_str, "09:30:00", 4, "Firestorm Games", "CUP", "TCG", "Large prize pool league cup", "Exclusive Playmat + CP + Packs", "£20.00")
