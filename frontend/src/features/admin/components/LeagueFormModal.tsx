...
export interface LeagueFormModalProps {
    ...
    onClose: () => void;
    onSubmit: (
        data: Omit<League, 'leagueId'> & { leagueId?: number; id?: number }
    ) => void;
...
export const LeagueFormModal: React.FC<LeagueFormModalProps> = ({
    ...
    const [leagueId, setLeagueId] = useState(
        initialData?.leagueId ? String(initialData.leagueId) : ''
    );
    ...
    return createPortal(
        ...
        >
            <div
                className="bg-bg-card border border-border-color rounded-lg w-full max-w-162.5 max-h-[90vh] shadow-[0_20px_25px_-5px_rgba(0,0,0,0.15),0_10px_10px_-5px_rgba(0,0,0,0.04)] flex flex-col overflow-hidden animate-[slideUp_0.3s_cubic-bezier(0.16,1,0.3,1)]"
                        ...
                        <h3>
                            {isChampionshipLeague
                                ? initialData
                                    ...
                                    : 'Add Championship Series'
                                : initialData
                                  ? 'Edit League / Store'
                                  : 'Add New League / Store'}
                        </h3>
                        {isChampionshipLeague && (
                ...
                >
                    <div className="p-7 overflow-y-auto">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            >
                                <label
                                    htmlFor="leagueSocialLink"
                                    className="text-[13px] font-bold text-text-main flex justify-between items-center"
                                >
                                    Social Media URL (e.g. Facebook)
                                </label>
                                <input
                                    type="url"
                                    id="leagueSocialLink"
