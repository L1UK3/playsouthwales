...
You can run the application services either inside Docker containers (recommended) or natively on your host machine.

### Option A: Run via Docker Compose (Containerized)
